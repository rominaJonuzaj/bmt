...
import { ALLOCATION_DEFINITION } from "../../constants/Constants";
interface Props {
  setModalVisible: (modalVisible: boolean) => void;
  modalVisible: boolean;
}

const AllocationModal: React.FC<Props> = ({ setModalVisible, modalVisible }) => {
  return (
    <Modal isVisible={modalVisible}>
      <TouchableOpacity style={styles.centeredView} onPressOut={() => setModalVisible(!modalVisible)}>
        <View style={styles.modalView}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>Allocation</Text>
          ...
          <View style={styles.modalContainer}>
            <Text style={styles.modalText}>{ALLOCATION_DEFINITION}</Text>
          </View>
        </View>
      </TouchableOpacity>
    </Modal>
